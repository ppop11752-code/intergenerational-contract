...
|---|---|---|---|
| 1 | Mandatory presentation / obligations / liquidation / bankruptcy | SOURCE VALIDATION ACTIVE | Obtain direct presentation approval |
| 2 | Status Purchase / 15s / next-round effect / married rep / fallback / Noble cap-refund | NOT DIRECTLY APPROVED | Source validate after Mandatory |
...
- Status has authoritative max 15s.
